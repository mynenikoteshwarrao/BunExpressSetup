...
3. **Set up environment variables**
   ...
   PORT=8000
   MONGODB_URI=mongodb://localhost:27017/swagger-demo-test
...
| `MONGODB_URI` | MongoDB connection string | `mongodb://localhost:27017/swagger-demo-test` |
